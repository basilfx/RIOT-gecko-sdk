/**************************************************************************//**
 * @file
 * @brief EFR32FG25 MSC register and bit field definitions
 ******************************************************************************
 * # License
 ...
 *
 *****************************************************************************/
#ifndef EFR32FG25_MSC_H
#define EFR32FG25_MSC_H
...
******************************************************************************/
/**************************************************************************//**
 * @defgroup EFR32FG25_MSC MSC
 * @{
 * @brief EFR32FG25 MSC Register Declaration.
 *****************************************************************************/
...
typedef struct {
  ...
  __IOM uint32_t PAGELOCK6;                     /**< Main space page 192-223 lock word                  */
  __IOM uint32_t PAGELOCK7;                     /**< Main space page 224-256 lock word                  */
  ...
  uint32_t       RESERVED10[908U];              /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED13[51U];               /**< Reserved for future use                            */
  ...
  __IOM uint32_t PAGELOCK6_SET;                 /**< Main space page 192-223 lock word                  */
  __IOM uint32_t PAGELOCK7_SET;                 /**< Main space page 224-256 lock word                  */
  ...
  uint32_t       RESERVED21[908U];              /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED24[51U];               /**< Reserved for future use                            */
  ...
  __IOM uint32_t PAGELOCK6_CLR;                 /**< Main space page 192-223 lock word                  */
  __IOM uint32_t PAGELOCK7_CLR;                 /**< Main space page 224-256 lock word                  */
  ...
  uint32_t       RESERVED28[12U];               /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED32[908U];              /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED35[51U];               /**< Reserved for future use                            */
  ...
  __IOM uint32_t PAGELOCK6_TGL;                 /**< Main space page 192-223 lock word                  */
  __IOM uint32_t PAGELOCK7_TGL;                 /**< Main space page 224-256 lock word                  */
  ...
  uint32_t       RESERVED39[12U];               /**< Reserved for future use                            */
...
/** @} End of group EFR32FG25_MSC */

/**************************************************************************//**
 * @addtogroup EFR32FG25_MSC
 * @{
 * @defgroup EFR32FG25_MSC_BitFields MSC Bit Fields
 * @{
 *****************************************************************************/

/* Bit fields for MSC IPVERSION */
#define _MSC_IPVERSION_RESETVALUE                 0x00000004UL                            /**< Default value for MSC_IPVERSION             */
...
#define _MSC_IPVERSION_IPVERSION_DEFAULT          0x00000004UL                            /**< Mode DEFAULT for MSC_IPVERSION              */
...
/* Bit fields for MSC PAGELOCK6 */
#define _MSC_PAGELOCK6_RESETVALUE                 0x00000000UL                          /**< Default value for MSC_PAGELOCK6             */
#define _MSC_PAGELOCK6_MASK                       0xFFFFFFFFUL                          /**< Mask for MSC_PAGELOCK6                      */
#define _MSC_PAGELOCK6_LOCKBIT_SHIFT              0                                     /**< Shift value for MSC_LOCKBIT                 */
#define _MSC_PAGELOCK6_LOCKBIT_MASK               0xFFFFFFFFUL                          /**< Bit mask for MSC_LOCKBIT                    */
#define _MSC_PAGELOCK6_LOCKBIT_DEFAULT            0x00000000UL                          /**< Mode DEFAULT for MSC_PAGELOCK6              */
#define MSC_PAGELOCK6_LOCKBIT_DEFAULT             (_MSC_PAGELOCK6_LOCKBIT_DEFAULT << 0) /**< Shifted mode DEFAULT for MSC_PAGELOCK6      */

/* Bit fields for MSC PAGELOCK7 */
#define _MSC_PAGELOCK7_RESETVALUE                 0x00000000UL                          /**< Default value for MSC_PAGELOCK7             */
#define _MSC_PAGELOCK7_MASK                       0xFFFFFFFFUL                          /**< Mask for MSC_PAGELOCK7                      */
#define _MSC_PAGELOCK7_LOCKBIT_SHIFT              0                                     /**< Shift value for MSC_LOCKBIT                 */
#define _MSC_PAGELOCK7_LOCKBIT_MASK               0xFFFFFFFFUL                          /**< Bit mask for MSC_LOCKBIT                    */
#define _MSC_PAGELOCK7_LOCKBIT_DEFAULT            0x00000000UL                          /**< Mode DEFAULT for MSC_PAGELOCK7              */
#define MSC_PAGELOCK7_LOCKBIT_DEFAULT             (_MSC_PAGELOCK7_LOCKBIT_DEFAULT << 0) /**< Shifted mode DEFAULT for MSC_PAGELOCK7      */

/** @} End of group EFR32FG25_MSC_BitFields */
/** @} End of group EFR32FG25_MSC */
/** @} End of group Parts */

#endif // EFR32FG25_MSC_H
