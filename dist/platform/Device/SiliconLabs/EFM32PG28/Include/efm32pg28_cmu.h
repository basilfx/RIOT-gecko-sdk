/**************************************************************************//**
 * @file
 * @brief EFM32PG28 CMU register and bit field definitions
 ******************************************************************************
 * # License
 ...
 *
 *****************************************************************************/
#ifndef EFM32PG28_CMU_H
#define EFM32PG28_CMU_H
...
******************************************************************************/
/**************************************************************************//**
 * @defgroup EFM32PG28_CMU CMU
 * @{
 * @brief EFM32PG28 CMU Register Declaration.
 *****************************************************************************/
...
typedef struct {
  ...
  uint32_t       RESERVED24[857U];              /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED49[857U];              /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED74[857U];              /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED96[7U];                /**< Reserved for future use                            */
  __IOM uint32_t LESENSEHFCLKCTRL_TGL;          /**< LESENSE HF Clock Control                           */
  uint32_t       RESERVED97[1U];                /**< Reserved for future use                            */
  uint32_t       RESERVED98[1U];                /**< Reserved for future use                            */
} CMU_TypeDef;
/** @} End of group EFM32PG28_CMU */

/**************************************************************************//**
 * @addtogroup EFM32PG28_CMU
 * @{
 * @defgroup EFM32PG28_CMU_BitFields CMU Bit Fields
 * @{
 *****************************************************************************/
...
/** @} End of group EFM32PG28_CMU_BitFields */
/** @} End of group EFM32PG28_CMU */
/** @} End of group Parts */

#endif // EFM32PG28_CMU_H
