/**************************************************************************//**
 * @file
 * @brief EFR32FG25 DCDC register and bit field definitions
 ******************************************************************************
 * # License
 ...
 *
 *****************************************************************************/
#ifndef EFR32FG25_DCDC_H
#define EFR32FG25_DCDC_H
...
******************************************************************************/
/**************************************************************************//**
 * @defgroup EFR32FG25_DCDC DCDC
 * @{
 * @brief EFR32FG25 DCDC Register Declaration.
 *****************************************************************************/
...
typedef struct {
  ...
  uint32_t       RESERVED23[986U];              /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED35[986U];              /**< Reserved for future use                            */
...
/** @} End of group EFR32FG25_DCDC */

/**************************************************************************//**
 * @addtogroup EFR32FG25_DCDC
 * @{
 * @defgroup EFR32FG25_DCDC_BitFields DCDC Bit Fields
 * @{
 *****************************************************************************/
...
#define _DCDC_EM01CTRL0_RESETVALUE                  0x00000199UL                                    /**< Default value for DCDC_EM01CTRL0            */
#define _DCDC_EM01CTRL0_MASK                        0x000003FFUL                                    /**< Mask for DCDC_EM01CTRL0                     */
...
#define _DCDC_EM23CTRL0_RESETVALUE                  0x00000133UL                                    /**< Default value for DCDC_EM23CTRL0            */
#define _DCDC_EM23CTRL0_MASK                        0x000003FFUL                                    /**< Mask for DCDC_EM23CTRL0                     */
...
#define _DCDC_SYNCBUSY_MASK                         0x000001FFUL                            /**< Mask for DCDC_SYNCBUSY                      */
...
/** @} End of group EFR32FG25_DCDC_BitFields */
/** @} End of group EFR32FG25_DCDC */
/** @} End of group Parts */

#endif // EFR32FG25_DCDC_H
