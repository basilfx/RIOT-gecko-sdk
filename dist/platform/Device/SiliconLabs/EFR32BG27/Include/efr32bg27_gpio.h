/**************************************************************************//**
 * @file
 * @brief EFR32BG27 GPIO register and bit field definitions
 ******************************************************************************
 * # License
 ...
 *
 *****************************************************************************/
#ifndef EFR32BG27_GPIO_H
#define EFR32BG27_GPIO_H
...
typedef struct {
  ...
  GPIO_EUSARTROUTE_TypeDef  EUSARTROUTE[1U];         /**< eusart0 DBUS config registers                      */
  ...
  uint32_t                  RESERVED10[611U];        /**< Reserved for future use                            */
  ...
  GPIO_EUSARTROUTE_TypeDef  EUSARTROUTE_SET[1U];     /**< eusart0 DBUS config registers                      */
  ...
  uint32_t                  RESERVED21[611U];        /**< Reserved for future use                            */
  ...
  GPIO_EUSARTROUTE_TypeDef  EUSARTROUTE_CLR[1U];     /**< eusart0 DBUS config registers                      */
  ...
  uint32_t                  RESERVED32[611U];        /**< Reserved for future use                            */
  ...
  GPIO_EUSARTROUTE_TypeDef  EUSARTROUTE_TGL[1U];     /**< eusart0 DBUS config registers                      */
...
#define _GPIO_IPVERSION_RESETVALUE                    0x00000005UL                             /**< Default value for GPIO_IPVERSION            */
...
#define _GPIO_IPVERSION_IPVERSION_DEFAULT             0x00000005UL                             /**< Mode DEFAULT for GPIO_IPVERSION             */
