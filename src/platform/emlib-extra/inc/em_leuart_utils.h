...
#ifndef EM_LEUART_UTILS_H
#define EM_LEUART_UTILS_H
...
/***************************************************************************//**
 * @addtogroup leuart_utils LEUART Utils - Low Energy UART utilities
 * @brief Low Energy Universal Asynchronous Receiver/Transmitter (LEUART)
 *        utility API
 * @{
 ******************************************************************************/
 ...
 ******************************************************************************/
__STATIC_INLINE LEUART_Databits_TypeDef LEUART_DataBits2Def(uint8_t bits)
{
 ...
 *   Corresponding enum value.
 ******************************************************************************/
__STATIC_INLINE LEUART_Stopbits_TypeDef LEUART_StopBits2Def(uint8_t half_bits)
{
 ...
 *   Corresponding enum value.
 ******************************************************************************/
__STATIC_INLINE LEUART_Parity_TypeDef LEUART_Parity2Def(uint8_t number)
{
 ...
 *   Parity mode.
 ******************************************************************************/
__STATIC_INLINE void LEUART_FrameSet(LEUART_TypeDef *leuart,
