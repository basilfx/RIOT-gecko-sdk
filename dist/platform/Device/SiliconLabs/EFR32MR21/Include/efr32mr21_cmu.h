/**************************************************************************//**
 * @file
 * @brief EFR32MR21 CMU register and bit field definitions
 ******************************************************************************
 * # License
 ...
 *
 *****************************************************************************/
#ifndef EFR32MR21_CMU_H
#define EFR32MR21_CMU_H
...
******************************************************************************/
/**************************************************************************//**
 * @defgroup EFR32MR21_CMU CMU
 * @{
 * @brief EFR32MR21 CMU Register Declaration.
 *****************************************************************************/
...
typedef struct {
  ...
  uint32_t       RESERVED11[39U];               /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED28[39U];               /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED45[39U];               /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED47[13U];               /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED49[13U];               /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED62[39U];               /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED64[13U];               /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED66[13U];               /**< Reserved for future use                            */
  __IOM uint32_t RADIOCLKCTRL_TGL;              /**< Radio Clock Control                                */
} CMU_TypeDef;
/** @} End of group EFR32MR21_CMU */

/**************************************************************************//**
 * @addtogroup EFR32MR21_CMU
 * @{
 * @defgroup EFR32MR21_CMU_BitFields CMU Bit Fields
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32MR21_CMU_BitFields */
/** @} End of group EFR32MR21_CMU */
/** @} End of group Parts */

#endif // EFR32MR21_CMU_H
