/**************************************************************************//**
 * @file
 * @brief EFR32FG25 LDMAXBAR register and bit field definitions
 ******************************************************************************
 * # License
 ...
 *
 *****************************************************************************/
#ifndef EFR32FG25_LDMAXBAR_H
#define EFR32FG25_LDMAXBAR_H
...
******************************************************************************/
/**************************************************************************//**
 * @defgroup EFR32FG25_LDMAXBAR LDMAXBAR
 * @{
 * @brief EFR32FG25 LDMAXBAR Register Declaration.
 *****************************************************************************/
...
typedef struct {
  ...
  LDMAXBAR_CH_TypeDef CH[16U];                  /**< DMA Channel Registers                              */
  uint32_t            RESERVED0[1007U];         /**< Reserved for future use                            */
  __IM uint32_t       IPVERSION_SET;            /**< IP veersion ID                                     */
  LDMAXBAR_CH_TypeDef CH_SET[16U];              /**< DMA Channel Registers                              */
  uint32_t            RESERVED1[1007U];         /**< Reserved for future use                            */
  __IM uint32_t       IPVERSION_CLR;            /**< IP veersion ID                                     */
  LDMAXBAR_CH_TypeDef CH_CLR[16U];              /**< DMA Channel Registers                              */
  uint32_t            RESERVED2[1007U];         /**< Reserved for future use                            */
  __IM uint32_t       IPVERSION_TGL;            /**< IP veersion ID                                     */
  LDMAXBAR_CH_TypeDef CH_TGL[16U];              /**< DMA Channel Registers                              */
} LDMAXBAR_TypeDef;
/** @} End of group EFR32FG25_LDMAXBAR */

/**************************************************************************//**
 * @addtogroup EFR32FG25_LDMAXBAR
 * @{
 * @defgroup EFR32FG25_LDMAXBAR_BitFields LDMAXBAR Bit Fields
 * @{
 *****************************************************************************/

/* Bit fields for LDMAXBAR IPVERSION */
#define _LDMAXBAR_IPVERSION_RESETVALUE           0x00000004UL                                 /**< Default value for LDMAXBAR_IPVERSION        */
...
#define _LDMAXBAR_IPVERSION_IPVERSION_DEFAULT    0x00000004UL                                 /**< Mode DEFAULT for LDMAXBAR_IPVERSION         */
...
/** @} End of group EFR32FG25_LDMAXBAR_BitFields */
/** @} End of group EFR32FG25_LDMAXBAR */
/** @} End of group Parts */

#endif // EFR32FG25_LDMAXBAR_H
