...

{
  ...
  qspi->CONFIG = _QSPI_CONFIG_RESETVALUE;
  qspi->DEVINSTRRDCONFIG = _QSPI_DEVINSTRRDCONFIG_RESETVALUE;
  qspi->DEVINSTRWRCONFIG = _QSPI_DEVINSTRWRCONFIG_RESETVALUE;
  qspi->DEVDELAY = _QSPI_DEVDELAY_RESETVALUE;
  qspi->RDDATACAPTURE = _QSPI_RDDATACAPTURE_RESETVALUE;
  qspi->DEVSIZECONFIG = _QSPI_DEVSIZECONFIG_RESETVALUE;
  qspi->SRAMPARTITIONCFG = _QSPI_SRAMPARTITIONCFG_RESETVALUE;
  qspi->INDAHBADDRTRIGGER = _QSPI_INDAHBADDRTRIGGER_RESETVALUE;
  qspi->REMAPADDR = _QSPI_REMAPADDR_RESETVALUE;
  qspi->MODEBITCONFIG = _QSPI_MODEBITCONFIG_RESETVALUE;
  qspi->TXTHRESH = _QSPI_TXTHRESH_RESETVALUE;
  qspi->RXTHRESH = _QSPI_RXTHRESH_RESETVALUE;
  qspi->WRITECOMPLETIONCTRL = _QSPI_WRITECOMPLETIONCTRL_RESETVALUE;
  qspi->NOOFPOLLSBEFEXP = _QSPI_NOOFPOLLSBEFEXP_RESETVALUE;
  qspi->IRQMASK = _QSPI_IRQMASK_RESETVALUE;
  qspi->IRQSTATUS = _QSPI_IRQSTATUS_RESETVALUE;
  qspi->LOWERWRPROT = _QSPI_LOWERWRPROT_RESETVALUE;
  qspi->UPPERWRPROT = _QSPI_UPPERWRPROT_RESETVALUE;
  qspi->WRPROTCTRL = _QSPI_WRPROTCTRL_RESETVALUE;
  qspi->INDIRECTREADXFERCTRL = _QSPI_INDIRECTREADXFERCTRL_RESETVALUE;
  qspi->INDIRECTREADXFERWATERMARK = _QSPI_INDIRECTREADXFERWATERMARK_RESETVALUE;
  qspi->INDIRECTREADXFERSTART = _QSPI_INDIRECTREADXFERSTART_RESETVALUE;
  qspi->INDIRECTREADXFERNUMBYTES = _QSPI_INDIRECTREADXFERNUMBYTES_RESETVALUE;
  qspi->INDIRECTWRITEXFERCTRL = _QSPI_INDIRECTWRITEXFERCTRL_RESETVALUE;
  qspi->INDIRECTWRITEXFERWATERMARK = _QSPI_INDIRECTWRITEXFERWATERMARK_RESETVALUE;
  qspi->INDIRECTWRITEXFERSTART = _QSPI_INDIRECTWRITEXFERSTART_RESETVALUE;
  qspi->INDIRECTWRITEXFERNUMBYTES = _QSPI_INDIRECTWRITEXFERNUMBYTES_RESETVALUE;
  qspi->INDIRECTTRIGGERADDRRANGE = _QSPI_INDIRECTTRIGGERADDRRANGE_RESETVALUE;
  qspi->FLASHCOMMANDCTRLMEM = _QSPI_FLASHCOMMANDCTRLMEM_RESETVALUE;
  qspi->FLASHCMDCTRL = _QSPI_FLASHCMDCTRL_RESETVALUE;
  qspi->FLASHCMDADDR = _QSPI_FLASHCMDADDR_RESETVALUE;
  qspi->FLASHWRDATALOWER = _QSPI_FLASHWRDATALOWER_RESETVALUE;
  qspi->FLASHWRDATAUPPER = _QSPI_FLASHWRDATAUPPER_RESETVALUE;
  qspi->POLLINGFLASHSTATUS = _QSPI_POLLINGFLASHSTATUS_RESETVALUE;
  qspi->PHYCONFIGURATION = _QSPI_PHYCONFIGURATION_RESETVALUE;
  qspi->OPCODEEXTLOWER = _QSPI_OPCODEEXTLOWER_RESETVALUE;
  qspi->OPCODEEXTUPPER = _QSPI_OPCODEEXTUPPER_RESETVALUE;
  qspi->ROUTEPEN = _QSPI_ROUTEPEN_RESETVALUE;
  qspi->ROUTELOC0 = _QSPI_ROUTELOC0_RESETVALUE;
}
