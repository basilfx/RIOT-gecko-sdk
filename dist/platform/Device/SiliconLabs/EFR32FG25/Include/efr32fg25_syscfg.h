/**************************************************************************//**
 * @file
 * @brief EFR32FG25 SYSCFG register and bit field definitions
 ******************************************************************************
 * # License
 ...
 *
 *****************************************************************************/
#ifndef EFR32FG25_SYSCFG_H
#define EFR32FG25_SYSCFG_H
...
******************************************************************************/
/**************************************************************************//**
 * @defgroup EFR32FG25_SYSCFG SYSCFG
 * @{
 * @brief EFR32FG25 SYSCFG Register Declaration.
 *****************************************************************************/
...
typedef struct {
  ...
  __IOM uint32_t CFGSYSTIC;                     /**< Configure Sys-Tick                                 */
  ...
  __IOM uint32_t CFGSYSTIC_SET;                 /**< Configure Sys-Tick                                 */
  ...
  __IOM uint32_t CFGSYSTIC_CLR;                 /**< Configure Sys-Tick                                 */
  ...
  __IOM uint32_t CFGSYSTIC_TGL;                 /**< Configure Sys-Tick                                 */
...
/** @} End of group EFR32FG25_SYSCFG */

/**************************************************************************//**
 * @addtogroup EFR32FG25_SYSCFG
 * @{
 * @defgroup EFR32FG25_SYSCFG_BitFields SYSCFG Bit Fields
 * @{
 *****************************************************************************/

/* Bit fields for SYSCFG IPVERSION */
#define _SYSCFG_IPVERSION_RESETVALUE                       0x00000004UL                               /**< Default value for SYSCFG_IPVERSION          */
...
#define _SYSCFG_IPVERSION_IPVERSION_DEFAULT                0x00000004UL                               /**< Mode DEFAULT for SYSCFG_IPVERSION           */
...
#define _SYSCFG_IF_MASK                                    0x3377BF0FUL                                 /**< Mask for SYSCFG_IF                          */
...
#define SYSCFG_IF_HOST2SRWBUSERR                           (0x1UL << 15)                                /**< HOST2SRWBUSERR Interrupt Flag               */
#define _SYSCFG_IF_HOST2SRWBUSERR_SHIFT                    15                                           /**< Shift value for SYSCFG_HOST2SRWBUSERR       */
#define _SYSCFG_IF_HOST2SRWBUSERR_MASK                     0x8000UL                                     /**< Bit mask for SYSCFG_HOST2SRWBUSERR          */
#define _SYSCFG_IF_HOST2SRWBUSERR_DEFAULT                  0x00000000UL                                 /**< Mode DEFAULT for SYSCFG_IF                  */
#define SYSCFG_IF_HOST2SRWBUSERR_DEFAULT                   (_SYSCFG_IF_HOST2SRWBUSERR_DEFAULT << 15)    /**< Shifted mode DEFAULT for SYSCFG_IF          */
#define SYSCFG_IF_SRW2HOSTBUSERR                           (0x1UL << 16)                                /**< SRW2HOSTBUSERR Interrupt Flag               */
#define _SYSCFG_IF_SRW2HOSTBUSERR_SHIFT                    16                                           /**< Shift value for SYSCFG_SRW2HOSTBUSERR       */
#define _SYSCFG_IF_SRW2HOSTBUSERR_MASK                     0x10000UL                                    /**< Bit mask for SYSCFG_SRW2HOSTBUSERR          */
#define _SYSCFG_IF_SRW2HOSTBUSERR_DEFAULT                  0x00000000UL                                 /**< Mode DEFAULT for SYSCFG_IF                  */
#define SYSCFG_IF_SRW2HOSTBUSERR_DEFAULT                   (_SYSCFG_IF_SRW2HOSTBUSERR_DEFAULT << 16)    /**< Shifted mode DEFAULT for SYSCFG_IF          */
#define SYSCFG_IF_SRW2SOFTMBUSERR                          (0x1UL << 17)                                /**< SRW2SOFTMBUSERR Interrupt Flag              */
#define _SYSCFG_IF_SRW2SOFTMBUSERR_SHIFT                   17                                           /**< Shift value for SYSCFG_SRW2SOFTMBUSERR      */
#define _SYSCFG_IF_SRW2SOFTMBUSERR_MASK                    0x20000UL                                    /**< Bit mask for SYSCFG_SRW2SOFTMBUSERR         */
#define _SYSCFG_IF_SRW2SOFTMBUSERR_DEFAULT                 0x00000000UL                                 /**< Mode DEFAULT for SYSCFG_IF                  */
#define SYSCFG_IF_SRW2SOFTMBUSERR_DEFAULT                  (_SYSCFG_IF_SRW2SOFTMBUSERR_DEFAULT << 17)   /**< Shifted mode DEFAULT for SYSCFG_IF          */
#define SYSCFG_IF_SOFTM2SRWBUSERR                          (0x1UL << 18)                                /**< SOFTM2SRWBUSERR Interrupt Flag              */
#define _SYSCFG_IF_SOFTM2SRWBUSERR_SHIFT                   18                                           /**< Shift value for SYSCFG_SOFTM2SRWBUSERR      */
#define _SYSCFG_IF_SOFTM2SRWBUSERR_MASK                    0x40000UL                                    /**< Bit mask for SYSCFG_SOFTM2SRWBUSERR         */
#define _SYSCFG_IF_SOFTM2SRWBUSERR_DEFAULT                 0x00000000UL                                 /**< Mode DEFAULT for SYSCFG_IF                  */
#define SYSCFG_IF_SOFTM2SRWBUSERR_DEFAULT                  (_SYSCFG_IF_SOFTM2SRWBUSERR_DEFAULT << 18)   /**< Shifted mode DEFAULT for SYSCFG_IF          */
#define SYSCFG_IF_SOFTMBUSERRIF                            (0x1UL << 20)                                /**< Softm bus error Interrupt Flag              */
#define _SYSCFG_IF_SOFTMBUSERRIF_SHIFT                     20                                           /**< Shift value for SYSCFG_SOFTMBUSERRIF        */
#define _SYSCFG_IF_SOFTMBUSERRIF_MASK                      0x100000UL                                   /**< Bit mask for SYSCFG_SOFTMBUSERRIF           */
#define _SYSCFG_IF_SOFTMBUSERRIF_DEFAULT                   0x00000000UL                                 /**< Mode DEFAULT for SYSCFG_IF                  */
#define SYSCFG_IF_SOFTMBUSERRIF_DEFAULT                    (_SYSCFG_IF_SOFTMBUSERRIF_DEFAULT << 20)     /**< Shifted mode DEFAULT for SYSCFG_IF          */
#define SYSCFG_IF_SOFTMDTCMRAMERRIF                        (0x1UL << 21)                                /**< Softm DTCM Error Interrupt Flag             */
#define _SYSCFG_IF_SOFTMDTCMRAMERRIF_SHIFT                 21                                           /**< Shift value for SYSCFG_SOFTMDTCMRAMERRIF    */
#define _SYSCFG_IF_SOFTMDTCMRAMERRIF_MASK                  0x200000UL                                   /**< Bit mask for SYSCFG_SOFTMDTCMRAMERRIF       */
#define _SYSCFG_IF_SOFTMDTCMRAMERRIF_DEFAULT               0x00000000UL                                 /**< Mode DEFAULT for SYSCFG_IF                  */
#define SYSCFG_IF_SOFTMDTCMRAMERRIF_DEFAULT                (_SYSCFG_IF_SOFTMDTCMRAMERRIF_DEFAULT << 21) /**< Shifted mode DEFAULT for SYSCFG_IF          */
#define SYSCFG_IF_SOFTMITCMRAMERRIF                        (0x1UL << 22)                                /**< Softm ITCM Error Interrupt Flag             */
#define _SYSCFG_IF_SOFTMITCMRAMERRIF_SHIFT                 22                                           /**< Shift value for SYSCFG_SOFTMITCMRAMERRIF    */
#define _SYSCFG_IF_SOFTMITCMRAMERRIF_MASK                  0x400000UL                                   /**< Bit mask for SYSCFG_SOFTMITCMRAMERRIF       */
#define _SYSCFG_IF_SOFTMITCMRAMERRIF_DEFAULT               0x00000000UL                                 /**< Mode DEFAULT for SYSCFG_IF                  */
#define SYSCFG_IF_SOFTMITCMRAMERRIF_DEFAULT                (_SYSCFG_IF_SOFTMITCMRAMERRIF_DEFAULT << 22) /**< Shifted mode DEFAULT for SYSCFG_IF          */
...
#define _SYSCFG_IEN_MASK                                   0x3377BF0FUL                                   /**< Mask for SYSCFG_IEN                         */
...
#define SYSCFG_IEN_HOST2SRWBUSERR                          (0x1UL << 15)                                  /**< HOST2SRWBUSERR Interrupt Enable             */
#define _SYSCFG_IEN_HOST2SRWBUSERR_SHIFT                   15                                             /**< Shift value for SYSCFG_HOST2SRWBUSERR       */
#define _SYSCFG_IEN_HOST2SRWBUSERR_MASK                    0x8000UL                                       /**< Bit mask for SYSCFG_HOST2SRWBUSERR          */
#define _SYSCFG_IEN_HOST2SRWBUSERR_DEFAULT                 0x00000000UL                                   /**< Mode DEFAULT for SYSCFG_IEN                 */
#define SYSCFG_IEN_HOST2SRWBUSERR_DEFAULT                  (_SYSCFG_IEN_HOST2SRWBUSERR_DEFAULT << 15)     /**< Shifted mode DEFAULT for SYSCFG_IEN         */
#define SYSCFG_IEN_SRW2HOSTBUSERR                          (0x1UL << 16)                                  /**< SRW2HOSTBUSERR Interrupt Enable             */
#define _SYSCFG_IEN_SRW2HOSTBUSERR_SHIFT                   16                                             /**< Shift value for SYSCFG_SRW2HOSTBUSERR       */
#define _SYSCFG_IEN_SRW2HOSTBUSERR_MASK                    0x10000UL                                      /**< Bit mask for SYSCFG_SRW2HOSTBUSERR          */
#define _SYSCFG_IEN_SRW2HOSTBUSERR_DEFAULT                 0x00000000UL                                   /**< Mode DEFAULT for SYSCFG_IEN                 */
#define SYSCFG_IEN_SRW2HOSTBUSERR_DEFAULT                  (_SYSCFG_IEN_SRW2HOSTBUSERR_DEFAULT << 16)     /**< Shifted mode DEFAULT for SYSCFG_IEN         */
#define SYSCFG_IEN_SRW2SOFTMBUSERR                         (0x1UL << 17)                                  /**< SRW2SOFTMBUSERR Interrupt Enable            */
#define _SYSCFG_IEN_SRW2SOFTMBUSERR_SHIFT                  17                                             /**< Shift value for SYSCFG_SRW2SOFTMBUSERR      */
#define _SYSCFG_IEN_SRW2SOFTMBUSERR_MASK                   0x20000UL                                      /**< Bit mask for SYSCFG_SRW2SOFTMBUSERR         */
#define _SYSCFG_IEN_SRW2SOFTMBUSERR_DEFAULT                0x00000000UL                                   /**< Mode DEFAULT for SYSCFG_IEN                 */
#define SYSCFG_IEN_SRW2SOFTMBUSERR_DEFAULT                 (_SYSCFG_IEN_SRW2SOFTMBUSERR_DEFAULT << 17)    /**< Shifted mode DEFAULT for SYSCFG_IEN         */
#define SYSCFG_IEN_SOFTM2SRWBUSERR                         (0x1UL << 18)                                  /**< SOFTM2SRWBUSERR Interrupt Enable            */
#define _SYSCFG_IEN_SOFTM2SRWBUSERR_SHIFT                  18                                             /**< Shift value for SYSCFG_SOFTM2SRWBUSERR      */
#define _SYSCFG_IEN_SOFTM2SRWBUSERR_MASK                   0x40000UL                                      /**< Bit mask for SYSCFG_SOFTM2SRWBUSERR         */
#define _SYSCFG_IEN_SOFTM2SRWBUSERR_DEFAULT                0x00000000UL                                   /**< Mode DEFAULT for SYSCFG_IEN                 */
#define SYSCFG_IEN_SOFTM2SRWBUSERR_DEFAULT                 (_SYSCFG_IEN_SOFTM2SRWBUSERR_DEFAULT << 18)    /**< Shifted mode DEFAULT for SYSCFG_IEN         */
#define SYSCFG_IEN_SOFTMBUSERRIEN                          (0x1UL << 20)                                  /**< Softm bus error interrupt Enable            */
#define _SYSCFG_IEN_SOFTMBUSERRIEN_SHIFT                   20                                             /**< Shift value for SYSCFG_SOFTMBUSERRIEN       */
#define _SYSCFG_IEN_SOFTMBUSERRIEN_MASK                    0x100000UL                                     /**< Bit mask for SYSCFG_SOFTMBUSERRIEN          */
#define _SYSCFG_IEN_SOFTMBUSERRIEN_DEFAULT                 0x00000000UL                                   /**< Mode DEFAULT for SYSCFG_IEN                 */
#define SYSCFG_IEN_SOFTMBUSERRIEN_DEFAULT                  (_SYSCFG_IEN_SOFTMBUSERRIEN_DEFAULT << 20)     /**< Shifted mode DEFAULT for SYSCFG_IEN         */
#define SYSCFG_IEN_SOFTMDTCMRAMERRIEN                      (0x1UL << 21)                                  /**< Softm DTCM Error Interrupt Enable           */
#define _SYSCFG_IEN_SOFTMDTCMRAMERRIEN_SHIFT               21                                             /**< Shift value for SYSCFG_SOFTMDTCMRAMERRIEN   */
#define _SYSCFG_IEN_SOFTMDTCMRAMERRIEN_MASK                0x200000UL                                     /**< Bit mask for SYSCFG_SOFTMDTCMRAMERRIEN      */
#define _SYSCFG_IEN_SOFTMDTCMRAMERRIEN_DEFAULT             0x00000000UL                                   /**< Mode DEFAULT for SYSCFG_IEN                 */
#define SYSCFG_IEN_SOFTMDTCMRAMERRIEN_DEFAULT              (_SYSCFG_IEN_SOFTMDTCMRAMERRIEN_DEFAULT << 21) /**< Shifted mode DEFAULT for SYSCFG_IEN         */
#define SYSCFG_IEN_SOFTMITCMRAMERRIEN                      (0x1UL << 22)                                  /**< Softm ITCM Error Interrupt Enable           */
#define _SYSCFG_IEN_SOFTMITCMRAMERRIEN_SHIFT               22                                             /**< Shift value for SYSCFG_SOFTMITCMRAMERRIEN   */
#define _SYSCFG_IEN_SOFTMITCMRAMERRIEN_MASK                0x400000UL                                     /**< Bit mask for SYSCFG_SOFTMITCMRAMERRIEN      */
#define _SYSCFG_IEN_SOFTMITCMRAMERRIEN_DEFAULT             0x00000000UL                                   /**< Mode DEFAULT for SYSCFG_IEN                 */
#define SYSCFG_IEN_SOFTMITCMRAMERRIEN_DEFAULT              (_SYSCFG_IEN_SOFTMITCMRAMERRIEN_DEFAULT << 22) /**< Shifted mode DEFAULT for SYSCFG_IEN         */
...
#define _SYSCFG_CHIPREVHW_RESETVALUE                       0x00010010UL                                /**< Default value for SYSCFG_CHIPREVHW          */
...
#define _SYSCFG_CHIPREVHW_PARTNUMBER_DEFAULT               0x00000010UL                                /**< Mode DEFAULT for SYSCFG_CHIPREVHW           */
...
#define SYSCFG_CFGSYSTIC_SYSTICEXTCLKEN                    (0x1UL << 0)                                    /**< System-Tick External Clock Enable           */
...
#define _SYSCFG_RADIORAMRETNCTRL_MASK                      0xF33FF107UL                                            /**< Mask for SYSCFG_RADIORAMRETNCTRL            */
#define _SYSCFG_RADIORAMRETNCTRL_SEQRAMRETNCTRL_SHIFT      0                                                       /**< Shift value for SYSCFG_SEQRAMRETNCTRL       */
#define _SYSCFG_RADIORAMRETNCTRL_SEQRAMRETNCTRL_MASK       0x7UL                                                   /**< Bit mask for SYSCFG_SEQRAMRETNCTRL          */
...
#define _SYSCFG_RADIORAMRETNCTRL_SEQRAMRETNCTRL_BLK2       0x00000004UL                                            /**< Mode BLK2 for SYSCFG_RADIORAMRETNCTRL       */
#define _SYSCFG_RADIORAMRETNCTRL_SEQRAMRETNCTRL_BLK1TO2    0x00000006UL                                            /**< Mode BLK1TO2 for SYSCFG_RADIORAMRETNCTRL    */
#define _SYSCFG_RADIORAMRETNCTRL_SEQRAMRETNCTRL_ALLOFF     0x00000007UL                                            /**< Mode ALLOFF for SYSCFG_RADIORAMRETNCTRL     */
...
#define SYSCFG_RADIORAMRETNCTRL_SEQRAMRETNCTRL_BLK2        (_SYSCFG_RADIORAMRETNCTRL_SEQRAMRETNCTRL_BLK2 << 0)     /**< Shifted mode BLK2 for SYSCFG_RADIORAMRETNCTRL*/
#define SYSCFG_RADIORAMRETNCTRL_SEQRAMRETNCTRL_BLK1TO2     (_SYSCFG_RADIORAMRETNCTRL_SEQRAMRETNCTRL_BLK1TO2 << 0)  /**< Shifted mode BLK1TO2 for SYSCFG_RADIORAMRETNCTRL*/
...
#define _SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_SHIFT      12                                                      /**< Shift value for SYSCFG_ITCRAMRETNCTRL       */
#define _SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_MASK       0x3FF000UL                                              /**< Bit mask for SYSCFG_ITCRAMRETNCTRL          */
#define _SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_DEFAULT    0x00000000UL                                            /**< Mode DEFAULT for SYSCFG_RADIORAMRETNCTRL    */
#define _SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_ALLON      0x00000000UL                                            /**< Mode ALLON for SYSCFG_RADIORAMRETNCTRL      */
#define _SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK9       0x00000200UL                                            /**< Mode BLK9 for SYSCFG_RADIORAMRETNCTRL       */
#define _SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK8TO9    0x00000300UL                                            /**< Mode BLK8TO9 for SYSCFG_RADIORAMRETNCTRL    */
#define _SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK7TO9    0x00000380UL                                            /**< Mode BLK7TO9 for SYSCFG_RADIORAMRETNCTRL    */
#define _SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK6TO9    0x000003C0UL                                            /**< Mode BLK6TO9 for SYSCFG_RADIORAMRETNCTRL    */
#define _SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK5TO9    0x000003E0UL                                            /**< Mode BLK5TO9 for SYSCFG_RADIORAMRETNCTRL    */
#define _SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK4TO9    0x000003F0UL                                            /**< Mode BLK4TO9 for SYSCFG_RADIORAMRETNCTRL    */
#define _SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK3TO9    0x000003F8UL                                            /**< Mode BLK3TO9 for SYSCFG_RADIORAMRETNCTRL    */
#define _SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK2TO9    0x000003FCUL                                            /**< Mode BLK2TO9 for SYSCFG_RADIORAMRETNCTRL    */
#define _SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK1TO9    0x000003FEUL                                            /**< Mode BLK1TO9 for SYSCFG_RADIORAMRETNCTRL    */
#define _SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_ALLOFF     0x000003FFUL                                            /**< Mode ALLOFF for SYSCFG_RADIORAMRETNCTRL     */
#define SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_DEFAULT     (_SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_DEFAULT << 12) /**< Shifted mode DEFAULT for SYSCFG_RADIORAMRETNCTRL*/
#define SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_ALLON       (_SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_ALLON << 12)   /**< Shifted mode ALLON for SYSCFG_RADIORAMRETNCTRL*/
#define SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK9        (_SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK9 << 12)    /**< Shifted mode BLK9 for SYSCFG_RADIORAMRETNCTRL*/
#define SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK8TO9     (_SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK8TO9 << 12) /**< Shifted mode BLK8TO9 for SYSCFG_RADIORAMRETNCTRL*/
#define SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK7TO9     (_SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK7TO9 << 12) /**< Shifted mode BLK7TO9 for SYSCFG_RADIORAMRETNCTRL*/
#define SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK6TO9     (_SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK6TO9 << 12) /**< Shifted mode BLK6TO9 for SYSCFG_RADIORAMRETNCTRL*/
#define SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK5TO9     (_SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK5TO9 << 12) /**< Shifted mode BLK5TO9 for SYSCFG_RADIORAMRETNCTRL*/
#define SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK4TO9     (_SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK4TO9 << 12) /**< Shifted mode BLK4TO9 for SYSCFG_RADIORAMRETNCTRL*/
#define SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK3TO9     (_SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK3TO9 << 12) /**< Shifted mode BLK3TO9 for SYSCFG_RADIORAMRETNCTRL*/
#define SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK2TO9     (_SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK2TO9 << 12) /**< Shifted mode BLK2TO9 for SYSCFG_RADIORAMRETNCTRL*/
#define SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK1TO9     (_SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_BLK1TO9 << 12) /**< Shifted mode BLK1TO9 for SYSCFG_RADIORAMRETNCTRL*/
#define SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_ALLOFF      (_SYSCFG_RADIORAMRETNCTRL_ITCRAMRETNCTRL_ALLOFF << 12)  /**< Shifted mode ALLOFF for SYSCFG_RADIORAMRETNCTRL*/
#define _SYSCFG_RADIORAMRETNCTRL_DTCRAMRETNCTRL_SHIFT      24                                                      /**< Shift value for SYSCFG_DTCRAMRETNCTRL       */
#define _SYSCFG_RADIORAMRETNCTRL_DTCRAMRETNCTRL_MASK       0x3000000UL                                             /**< Bit mask for SYSCFG_DTCRAMRETNCTRL          */
#define _SYSCFG_RADIORAMRETNCTRL_DTCRAMRETNCTRL_DEFAULT    0x00000000UL                                            /**< Mode DEFAULT for SYSCFG_RADIORAMRETNCTRL    */
#define _SYSCFG_RADIORAMRETNCTRL_DTCRAMRETNCTRL_ALLON      0x00000000UL                                            /**< Mode ALLON for SYSCFG_RADIORAMRETNCTRL      */
#define _SYSCFG_RADIORAMRETNCTRL_DTCRAMRETNCTRL_BLK1       0x00000002UL                                            /**< Mode BLK1 for SYSCFG_RADIORAMRETNCTRL       */
#define _SYSCFG_RADIORAMRETNCTRL_DTCRAMRETNCTRL_ALLOFF     0x00000003UL                                            /**< Mode ALLOFF for SYSCFG_RADIORAMRETNCTRL     */
#define SYSCFG_RADIORAMRETNCTRL_DTCRAMRETNCTRL_DEFAULT     (_SYSCFG_RADIORAMRETNCTRL_DTCRAMRETNCTRL_DEFAULT << 24) /**< Shifted mode DEFAULT for SYSCFG_RADIORAMRETNCTRL*/
#define SYSCFG_RADIORAMRETNCTRL_DTCRAMRETNCTRL_ALLON       (_SYSCFG_RADIORAMRETNCTRL_DTCRAMRETNCTRL_ALLON << 24)   /**< Shifted mode ALLON for SYSCFG_RADIORAMRETNCTRL*/
#define SYSCFG_RADIORAMRETNCTRL_DTCRAMRETNCTRL_BLK1        (_SYSCFG_RADIORAMRETNCTRL_DTCRAMRETNCTRL_BLK1 << 24)    /**< Shifted mode BLK1 for SYSCFG_RADIORAMRETNCTRL*/
#define SYSCFG_RADIORAMRETNCTRL_DTCRAMRETNCTRL_ALLOFF      (_SYSCFG_RADIORAMRETNCTRL_DTCRAMRETNCTRL_ALLOFF << 24)  /**< Shifted mode ALLOFF for SYSCFG_RADIORAMRETNCTRL*/
#define _SYSCFG_RADIORAMRETNCTRL_AHBRAMRETNCTRL_SHIFT      28                                                      /**< Shift value for SYSCFG_AHBRAMRETNCTRL       */
#define _SYSCFG_RADIORAMRETNCTRL_AHBRAMRETNCTRL_MASK       0xF0000000UL                                            /**< Bit mask for SYSCFG_AHBRAMRETNCTRL          */
#define _SYSCFG_RADIORAMRETNCTRL_AHBRAMRETNCTRL_DEFAULT    0x00000000UL                                            /**< Mode DEFAULT for SYSCFG_RADIORAMRETNCTRL    */
#define _SYSCFG_RADIORAMRETNCTRL_AHBRAMRETNCTRL_ALLON      0x00000000UL                                            /**< Mode ALLON for SYSCFG_RADIORAMRETNCTRL      */
#define _SYSCFG_RADIORAMRETNCTRL_AHBRAMRETNCTRL_BLK3       0x00000008UL                                            /**< Mode BLK3 for SYSCFG_RADIORAMRETNCTRL       */
#define _SYSCFG_RADIORAMRETNCTRL_AHBRAMRETNCTRL_BLK2TO3    0x0000000CUL                                            /**< Mode BLK2TO3 for SYSCFG_RADIORAMRETNCTRL    */
#define _SYSCFG_RADIORAMRETNCTRL_AHBRAMRETNCTRL_BLK1TO3    0x0000000EUL                                            /**< Mode BLK1TO3 for SYSCFG_RADIORAMRETNCTRL    */
#define _SYSCFG_RADIORAMRETNCTRL_AHBRAMRETNCTRL_ALLOFF     0x0000000FUL                                            /**< Mode ALLOFF for SYSCFG_RADIORAMRETNCTRL     */
#define SYSCFG_RADIORAMRETNCTRL_AHBRAMRETNCTRL_DEFAULT     (_SYSCFG_RADIORAMRETNCTRL_AHBRAMRETNCTRL_DEFAULT << 28) /**< Shifted mode DEFAULT for SYSCFG_RADIORAMRETNCTRL*/
#define SYSCFG_RADIORAMRETNCTRL_AHBRAMRETNCTRL_ALLON       (_SYSCFG_RADIORAMRETNCTRL_AHBRAMRETNCTRL_ALLON << 28)   /**< Shifted mode ALLON for SYSCFG_RADIORAMRETNCTRL*/
#define SYSCFG_RADIORAMRETNCTRL_AHBRAMRETNCTRL_BLK3        (_SYSCFG_RADIORAMRETNCTRL_AHBRAMRETNCTRL_BLK3 << 28)    /**< Shifted mode BLK3 for SYSCFG_RADIORAMRETNCTRL*/
#define SYSCFG_RADIORAMRETNCTRL_AHBRAMRETNCTRL_BLK2TO3     (_SYSCFG_RADIORAMRETNCTRL_AHBRAMRETNCTRL_BLK2TO3 << 28) /**< Shifted mode BLK2TO3 for SYSCFG_RADIORAMRETNCTRL*/
#define SYSCFG_RADIORAMRETNCTRL_AHBRAMRETNCTRL_BLK1TO3     (_SYSCFG_RADIORAMRETNCTRL_AHBRAMRETNCTRL_BLK1TO3 << 28) /**< Shifted mode BLK1TO3 for SYSCFG_RADIORAMRETNCTRL*/
#define SYSCFG_RADIORAMRETNCTRL_AHBRAMRETNCTRL_ALLOFF      (_SYSCFG_RADIORAMRETNCTRL_AHBRAMRETNCTRL_ALLOFF << 28)  /**< Shifted mode ALLOFF for SYSCFG_RADIORAMRETNCTRL*/
...
#define _SYSCFG_DMEM0PORTMAPSEL_RESETVALUE                 0x00000093UL                                          /**< Default value for SYSCFG_DMEM0PORTMAPSEL    */
#define _SYSCFG_DMEM0PORTMAPSEL_MASK                       0x000001FFUL                                          /**< Mask for SYSCFG_DMEM0PORTMAPSEL             */
...
#define SYSCFG_DMEM0PORTMAPSEL_LDMA1PORTSEL                (0x1UL << 5)                                          /**< LDMA port1 portmap selection                */
#define _SYSCFG_DMEM0PORTMAPSEL_LDMA1PORTSEL_SHIFT         5                                                     /**< Shift value for SYSCFG_LDMA1PORTSEL         */
#define _SYSCFG_DMEM0PORTMAPSEL_LDMA1PORTSEL_MASK          0x20UL                                                /**< Bit mask for SYSCFG_LDMA1PORTSEL            */
#define _SYSCFG_DMEM0PORTMAPSEL_LDMA1PORTSEL_DEFAULT       0x00000000UL                                          /**< Mode DEFAULT for SYSCFG_DMEM0PORTMAPSEL     */
#define SYSCFG_DMEM0PORTMAPSEL_LDMA1PORTSEL_DEFAULT        (_SYSCFG_DMEM0PORTMAPSEL_LDMA1PORTSEL_DEFAULT << 5)   /**< Shifted mode DEFAULT for SYSCFG_DMEM0PORTMAPSEL*/
#define SYSCFG_DMEM0PORTMAPSEL_SRWLDMAPORTSEL              (0x1UL << 6)                                          /**< SRWLDMA port1 portmap selection             */
#define _SYSCFG_DMEM0PORTMAPSEL_SRWLDMAPORTSEL_SHIFT       6                                                     /**< Shift value for SYSCFG_SRWLDMAPORTSEL       */
#define _SYSCFG_DMEM0PORTMAPSEL_SRWLDMAPORTSEL_MASK        0x40UL                                                /**< Bit mask for SYSCFG_SRWLDMAPORTSEL          */
#define _SYSCFG_DMEM0PORTMAPSEL_SRWLDMAPORTSEL_DEFAULT     0x00000000UL                                          /**< Mode DEFAULT for SYSCFG_DMEM0PORTMAPSEL     */
#define SYSCFG_DMEM0PORTMAPSEL_SRWLDMAPORTSEL_DEFAULT      (_SYSCFG_DMEM0PORTMAPSEL_SRWLDMAPORTSEL_DEFAULT << 6) /**< Shifted mode DEFAULT for SYSCFG_DMEM0PORTMAPSEL*/
#define SYSCFG_DMEM0PORTMAPSEL_USBPORTSEL                  (0x1UL << 7)                                          /**< USB portmap selection                       */
#define _SYSCFG_DMEM0PORTMAPSEL_USBPORTSEL_SHIFT           7                                                     /**< Shift value for SYSCFG_USBPORTSEL           */
#define _SYSCFG_DMEM0PORTMAPSEL_USBPORTSEL_MASK            0x80UL                                                /**< Bit mask for SYSCFG_USBPORTSEL              */
#define _SYSCFG_DMEM0PORTMAPSEL_USBPORTSEL_DEFAULT         0x00000001UL                                          /**< Mode DEFAULT for SYSCFG_DMEM0PORTMAPSEL     */
#define SYSCFG_DMEM0PORTMAPSEL_USBPORTSEL_DEFAULT          (_SYSCFG_DMEM0PORTMAPSEL_USBPORTSEL_DEFAULT << 7)     /**< Shifted mode DEFAULT for SYSCFG_DMEM0PORTMAPSEL*/
#define SYSCFG_DMEM0PORTMAPSEL_BUFCPORTSEL                 (0x1UL << 8)                                          /**< BUFC portmap selection                      */
#define _SYSCFG_DMEM0PORTMAPSEL_BUFCPORTSEL_SHIFT          8                                                     /**< Shift value for SYSCFG_BUFCPORTSEL          */
#define _SYSCFG_DMEM0PORTMAPSEL_BUFCPORTSEL_MASK           0x100UL                                               /**< Bit mask for SYSCFG_BUFCPORTSEL             */
#define _SYSCFG_DMEM0PORTMAPSEL_BUFCPORTSEL_DEFAULT        0x00000000UL                                          /**< Mode DEFAULT for SYSCFG_DMEM0PORTMAPSEL     */
#define SYSCFG_DMEM0PORTMAPSEL_BUFCPORTSEL_DEFAULT         (_SYSCFG_DMEM0PORTMAPSEL_BUFCPORTSEL_DEFAULT << 8)    /**< Shifted mode DEFAULT for SYSCFG_DMEM0PORTMAPSEL*/
...
#define SYSCFG_ROOTLOCKSTATUS_RADIODBGLOCK                 (0x1UL << 21)                                         /**< Radio Debug Lock                            */
#define _SYSCFG_ROOTLOCKSTATUS_RADIODBGLOCK_SHIFT          21                                                    /**< Shift value for SYSCFG_RADIODBGLOCK         */
#define _SYSCFG_ROOTLOCKSTATUS_RADIODBGLOCK_MASK           0x200000UL                                            /**< Bit mask for SYSCFG_RADIODBGLOCK            */
#define _SYSCFG_ROOTLOCKSTATUS_RADIODBGLOCK_DEFAULT        0x00000001UL                                          /**< Mode DEFAULT for SYSCFG_ROOTLOCKSTATUS      */
#define SYSCFG_ROOTLOCKSTATUS_RADIODBGLOCK_DEFAULT         (_SYSCFG_ROOTLOCKSTATUS_RADIODBGLOCK_DEFAULT << 21)   /**< Shifted mode DEFAULT for SYSCFG_ROOTLOCKSTATUS*/
#define SYSCFG_ROOTLOCKSTATUS_RADIOSMDBGLOCK               (0x1UL << 22)                                         /**< Radio Soft Modem Debug Lock                 */
#define _SYSCFG_ROOTLOCKSTATUS_RADIOSMDBGLOCK_SHIFT        22                                                    /**< Shift value for SYSCFG_RADIOSMDBGLOCK       */
#define _SYSCFG_ROOTLOCKSTATUS_RADIOSMDBGLOCK_MASK         0x400000UL                                            /**< Bit mask for SYSCFG_RADIOSMDBGLOCK          */
#define _SYSCFG_ROOTLOCKSTATUS_RADIOSMDBGLOCK_DEFAULT      0x00000001UL                                          /**< Mode DEFAULT for SYSCFG_ROOTLOCKSTATUS      */
#define SYSCFG_ROOTLOCKSTATUS_RADIOSMDBGLOCK_DEFAULT       (_SYSCFG_ROOTLOCKSTATUS_RADIOSMDBGLOCK_DEFAULT << 22) /**< Shifted mode DEFAULT for SYSCFG_ROOTLOCKSTATUS*/
...
/** @} End of group EFR32FG25_SYSCFG_BitFields */
/** @} End of group EFR32FG25_SYSCFG */
/**************************************************************************//**
 * @defgroup EFR32FG25_SYSCFG_CFGNS SYSCFG_CFGNS
 * @{
 * @brief EFR32FG25 SYSCFG_CFGNS Register Declaration.
 *****************************************************************************/
...
/** @} End of group EFR32FG25_SYSCFG_CFGNS */

/**************************************************************************//**
 * @addtogroup EFR32FG25_SYSCFG_CFGNS
 * @{
 * @defgroup EFR32FG25_SYSCFG_CFGNS_BitFields SYSCFG_CFGNS Bit Fields
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32FG25_SYSCFG_CFGNS_BitFields */
/** @} End of group EFR32FG25_SYSCFG_CFGNS */
/** @} End of group Parts */

#endif // EFR32FG25_SYSCFG_H
