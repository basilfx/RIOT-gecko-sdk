/**************************************************************************//**
 * @file
 * @brief EFR32FG25 EMU register and bit field definitions
 ******************************************************************************
 * # License
 ...
 *
 *****************************************************************************/
#ifndef EFR32FG25_EMU_H
#define EFR32FG25_EMU_H
...
******************************************************************************/
/**************************************************************************//**
 * @defgroup EFR32FG25_EMU EMU
 * @{
 * @brief EFR32FG25 EMU Register Declaration.
 *****************************************************************************/
...
typedef struct {
  ...
  uint32_t       RESERVED27[15U];               /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED39[6U];                /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED43[15U];               /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED55[6U];                /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED59[15U];               /**< Reserved for future use                            */
...
/** @} End of group EFR32FG25_EMU */

/**************************************************************************//**
 * @addtogroup EFR32FG25_EMU
 * @{
 * @defgroup EFR32FG25_EMU_BitFields EMU Bit Fields
 * @{
 *****************************************************************************/
...
#define _EMU_BOD3SENSE_MASK                             0x000000FFUL                              /**< Mask for EMU_BOD3SENSE                      */
...
#define EMU_BOD3SENSE_IOVDD0BODEN                       (0x1UL << 1)                              /**< IOVDD0 BOD enable                           */
...
#define EMU_BOD3SENSE_IOVDD1BODEN                       (0x1UL << 2)                              /**< IOVDD1 BOD enable                           */
...
#define EMU_BOD3SENSE_IOVDD2BODEN                       (0x1UL << 3)                              /**< IOVDD2 BOD enable                           */
#define _EMU_BOD3SENSE_IOVDD2BODEN_SHIFT                3                                         /**< Shift value for EMU_IOVDD2BODEN             */
#define _EMU_BOD3SENSE_IOVDD2BODEN_MASK                 0x8UL                                     /**< Bit mask for EMU_IOVDD2BODEN                */
#define _EMU_BOD3SENSE_IOVDD2BODEN_DEFAULT              0x00000000UL                              /**< Mode DEFAULT for EMU_BOD3SENSE              */
#define EMU_BOD3SENSE_IOVDD2BODEN_DEFAULT               (_EMU_BOD3SENSE_IOVDD2BODEN_DEFAULT << 3) /**< Shifted mode DEFAULT for EMU_BOD3SENSE      */
...
#define _EMU_IPVERSION_RESETVALUE                       0x00000004UL                            /**< Default value for EMU_IPVERSION             */
...
#define _EMU_IPVERSION_IPVERSION_DEFAULT                0x00000004UL                            /**< Mode DEFAULT for EMU_IPVERSION              */
...
#define _EMU_IF_MASK                                    0xE90F0000UL                       /**< Mask for EMU_IF                             */
...
#define EMU_IF_IOVDD0BOD                                (0x1UL << 17)                      /**< IOVDD0 BOD Interrupt flag                   */
...
#define EMU_IF_IOVDD1BOD                                (0x1UL << 18)                      /**< IOVDD1 BOD Interrupt flag                   */
...
#define EMU_IF_IOVDD2BOD                                (0x1UL << 19)                      /**< IOVDD2 BOD Interrupt flag                   */
#define _EMU_IF_IOVDD2BOD_SHIFT                         19                                 /**< Shift value for EMU_IOVDD2BOD               */
#define _EMU_IF_IOVDD2BOD_MASK                          0x80000UL                          /**< Bit mask for EMU_IOVDD2BOD                  */
#define _EMU_IF_IOVDD2BOD_DEFAULT                       0x00000000UL                       /**< Mode DEFAULT for EMU_IF                     */
#define EMU_IF_IOVDD2BOD_DEFAULT                        (_EMU_IF_IOVDD2BOD_DEFAULT << 19)  /**< Shifted mode DEFAULT for EMU_IF             */
...
#define _EMU_IEN_MASK                                   0xE90F0000UL                        /**< Mask for EMU_IEN                            */
...
#define EMU_IEN_IOVDD0BOD                               (0x1UL << 17)                       /**< IOVDD0 BOD Interrupt enable                 */
...
#define EMU_IEN_IOVDD1BOD                               (0x1UL << 18)                       /**< IOVDD1 BOD Interrupt enable                 */
...
#define EMU_IEN_IOVDD2BOD                               (0x1UL << 19)                       /**< IOVDD2 BOD Interrupt enable                 */
#define _EMU_IEN_IOVDD2BOD_SHIFT                        19                                  /**< Shift value for EMU_IOVDD2BOD               */
#define _EMU_IEN_IOVDD2BOD_MASK                         0x80000UL                           /**< Bit mask for EMU_IOVDD2BOD                  */
#define _EMU_IEN_IOVDD2BOD_DEFAULT                      0x00000000UL                        /**< Mode DEFAULT for EMU_IEN                    */
#define EMU_IEN_IOVDD2BOD_DEFAULT                       (_EMU_IEN_IOVDD2BOD_DEFAULT << 19)  /**< Shifted mode DEFAULT for EMU_IEN            */
...
#define _EMU_CTRL_MASK                                  0x00010309UL                                 /**< Mask for EMU_CTRL                           */
...
#define _EMU_RSTCTRL_MASK                               0xC006C7CFUL                                /**< Mask for EMU_RSTCTRL                        */
...
#define EMU_RSTCTRL_IOVDD0BODRMODE                      (0x1UL << 7)                                /**< Enable IOVDD0 BOD reset                     */
...
#define EMU_RSTCTRL_IOVDD1BODRMODE                      (0x1UL << 8)                                /**< Enable IOVDD1 BOD reset                     */
...
#define EMU_RSTCTRL_IOVDD2BODRMODE                      (0x1UL << 9)                                /**< Enable IOVDD2 BOD reset                     */
#define _EMU_RSTCTRL_IOVDD2BODRMODE_SHIFT               9                                           /**< Shift value for EMU_IOVDD2BODRMODE          */
#define _EMU_RSTCTRL_IOVDD2BODRMODE_MASK                0x200UL                                     /**< Bit mask for EMU_IOVDD2BODRMODE             */
#define _EMU_RSTCTRL_IOVDD2BODRMODE_DEFAULT             0x00000000UL                                /**< Mode DEFAULT for EMU_RSTCTRL                */
#define _EMU_RSTCTRL_IOVDD2BODRMODE_DISABLED            0x00000000UL                                /**< Mode DISABLED for EMU_RSTCTRL               */
#define _EMU_RSTCTRL_IOVDD2BODRMODE_ENABLED             0x00000001UL                                /**< Mode ENABLED for EMU_RSTCTRL                */
#define EMU_RSTCTRL_IOVDD2BODRMODE_DEFAULT              (_EMU_RSTCTRL_IOVDD2BODRMODE_DEFAULT << 9)  /**< Shifted mode DEFAULT for EMU_RSTCTRL        */
#define EMU_RSTCTRL_IOVDD2BODRMODE_DISABLED             (_EMU_RSTCTRL_IOVDD2BODRMODE_DISABLED << 9) /**< Shifted mode DISABLED for EMU_RSTCTRL       */
#define EMU_RSTCTRL_IOVDD2BODRMODE_ENABLED              (_EMU_RSTCTRL_IOVDD2BODRMODE_ENABLED << 9)  /**< Shifted mode ENABLED for EMU_RSTCTRL        */
...
#define _EMU_RSTCAUSE_MASK                              0x8016FFFFUL                            /**< Mask for EMU_RSTCAUSE                       */
...
#define EMU_RSTCAUSE_IOVDD2BOD                          (0x1UL << 20)                           /**< LEBOD4 Reset                                */
#define _EMU_RSTCAUSE_IOVDD2BOD_SHIFT                   20                                      /**< Shift value for EMU_IOVDD2BOD               */
#define _EMU_RSTCAUSE_IOVDD2BOD_MASK                    0x100000UL                              /**< Bit mask for EMU_IOVDD2BOD                  */
#define _EMU_RSTCAUSE_IOVDD2BOD_DEFAULT                 0x00000000UL                            /**< Mode DEFAULT for EMU_RSTCAUSE               */
#define EMU_RSTCAUSE_IOVDD2BOD_DEFAULT                  (_EMU_RSTCAUSE_IOVDD2BOD_DEFAULT << 20) /**< Shifted mode DEFAULT for EMU_RSTCAUSE       */
...
/** @} End of group EFR32FG25_EMU_BitFields */
/** @} End of group EFR32FG25_EMU */
/** @} End of group Parts */

#endif // EFR32FG25_EMU_H
